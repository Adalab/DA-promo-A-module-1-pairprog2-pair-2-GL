...
-- Preguntar porque el INT () no funciona
-- CREATE TABLE Empleados 
CREATE TABLE  Clientes (idEmpleado INT PRIMARY KEY AUTO_INCREMENT NOT NULL, Nombre CHAR(45) NOT NULL, Numero_telefono INT(9) NOT NULL, Email CHAR(45) NOT NULL, Direccion CHAR(45) NOT NULL, Ciudad CHAR(45), Provincia CHAR(45) NOT NULL, Codigo_postal INT(5) NOT NULL) ;
-- CREATE TABLE Facturas Primary Key
-- CREATE TABLE Zapatillas (idZapatillas INT AUTO_INCREMENT PRIMARY KEY NOT NULL, Modelo CHAR(45) NOT NULL, Talla INT NOT NULL, Color CHAR(45) NOT NULL);
